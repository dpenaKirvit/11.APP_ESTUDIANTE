...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-MI0DOS6\\SQLEXPRESS;Database=KIRVIT_App;Persist Security Info=False;User ID=sa;Password=root;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EvaluacionPractica>(entity =>
            {
                ...
                entity.HasIndex(e => e.MateriaPracticaEvaluado)
                    .HasName("iMateriaPracticaEvaluado_EvaluacionPractica");

                entity.HasIndex(e => e.PersonaEvaluado)
                    .HasName("iPersonaEvaluado_EvaluacionPractica");
                ...
                entity.HasOne(d => d.MateriaPracticaEvaluadoNavigation)
                    .WithMany(p => p.EvaluacionPractica)
                    .HasForeignKey(d => d.MateriaPracticaEvaluado)
                    .HasConstraintName("FK_EvaluacionPractica_MateriaPracticaEvaluado");

                entity.HasOne(d => d.PersonaEvaluadoNavigation)
                    .WithMany(p => p.EvaluacionPractica)
                    .HasForeignKey(d => d.PersonaEvaluado)
                    .HasConstraintName("FK_EvaluacionPractica_PersonaEvaluado");
